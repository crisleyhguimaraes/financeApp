...
export const TRANSACTION_CATEGORY_LABELS = {
    EDUCATION: "Educação",
    ENTERTAINMET: "Entretenimento",
    FOOD: "Alimentação",
    HEALTH: "Saúde",
    HOUSING: "Moradia",
    OTHER: "Outros",
    SALARY: "Salário",
    TANSPORTATION: "Transporte",
    UTILITY: "Utilidades",
};
...
export const TRANSACTION_CATEGORY_OPTIONS = [
    ...
    {
        value: TransactionCategory.ENTERTAINMET,
        label: TRANSACTION_CATEGORY_LABELS[TransactionCategory.ENTERTAINMET],
    },
    {
